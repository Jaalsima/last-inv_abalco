            ...
            <div class="p-5">
                ...
                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" name="id_usuario" id="id_usuario" placeholder="Documento Identidad">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control form-control-user" name="contra" id="contra" placeholder="Contraseña">
                    </div>
                    <div class="form-group">
