            ...
            <div>
                <table class="table table-bordered table-hover table-secondary">
                    ...
                    <tbody style="text-align: center;">
                        ...
                        $query = "SELECT id_movimiento, fk_id_prod, fk_id_det_compra, fk_id_det_venta, cantidad_comprada, cantidad_vendida, fecha_movimiento, responsable FROM movimiento";
                        ...
                        while ($fila = mysqli_fetch_array($resultado)) { ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $fila["fk_id_det_compra"] ?></td>
                                <td><?php echo $fila["fk_id_det_venta"] ?></td>
